...
读本{{TURN_UNIT}}诏书逐条落地情况：力度（投了多少银/人/权限）、阻力、结果三态（完成/进行中/中断）。`完成`＝一锤子事当{{TURN_UNIT}}了结（不涉长期局势）；`进行中`＝长期事，必有对应局势在第二章承接，issue 进度去那条读；`中断`＝没办成/搁置/折损。相关背景在 `decree_text` 与盘面表。
